...
RF = NP_Graph(W, Z, sigma_eta= diag(0.1,p), rho=0.1, sigma_delta = 0.1,
      label_name = TRUE, var_thred = 5)

### Make evaluation
Bhat = (RF$importance_matrix>5)*1
evaluation(B, Bhat)
evaluation(Omega, RF$precision_matrix)
